...
```
dfx canister call opend listItem '(principal "xghmb-iaaaa-aaaaa-aaavq-cai", 2)'
```
...
```
dfx canister call xghmb-iaaaa-aaaaa-aaavq-cai transferOwnership '(principal "ryjl3-tyaaa-aaaaa-aaaba-cai", true)'
```
